...
**Meeting Start Time:** 9:30 AM EST  
**Meeting End Time:** 10:15 AM EST  
...
- Score tracking discussion:  
  Team determined assigning quarter IDs to questions is **not needed** for our team.  
  Mobile app team would handle it if used later.
...
6. **Assignments, Testing, and Submission Plan**  
   ...
   - Ask Tim during 3:30 meeting about third iteration expectations.  
